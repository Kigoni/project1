        ...
        >
          ...
          <div className="relative">
            ...
            <p className="text-xl md:text-2xl text-gray-200 mb-8 pl-6 leading-relaxed">
              Welcome to <span className="text-yellow-400 font-semibold">Afrika Journals</span>,
              your premier hub for <span className="text-white font-semibold">cutting-edge African research</span> and
              scholarly excellence. We are committed to <span className="text-yellow-400 font-semibold">elevating African academia</span>
              by showcasing groundbreaking research and fostering global visibility for
              African journals.
            </p>
          </div>
          ...
          >
            ...
            <a href="#learn-more" className="text-gray-300 hover:text-white transition-colors duration-300">
              Learn More →
            </a>
          </motion.div>
        </motion.div>
