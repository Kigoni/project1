...
const Testimonials = () => {
  ...
  const testimonials = [
    {
      quote: "The platform transformed my research workflow. The comprehensive tools and resources available made my academic journey significantly smoother.",
      author: "Sarah Chen",
    ...
    {
      quote: "As an educator, I've seen countless platforms, but this one stands out for its intuitive design and robust features. It's become an essential tool in my teaching arsenal.",
    ...
    {
      quote: "The collaborative features have been invaluable for my research team. We've been able to streamline our workflow and improve our productivity significantly.",
          ...
          {testimonials.map((testimonial, index) => (
            ...
            >
              ...
              <motion.div
                ...
                className="relative"
              >
                <Quote className="text-blue-600 mb-4 transform -scale-x-100" size={32} />
              ...
              <div className="flex items-center">
                <div className="relative">
                  ...
                  />
                  <motion.div
                    className="absolute inset-0 rounded-full bg-blue-500 mix-blend-multiply"
                    initial={{ opacity: 0 }}
