...
import { Library, BookOpen, GraduationCap, TrendingUp, Award, Search, Filter, ChevronDown, ChevronUp, Bookmark, ThumbsUp, ThumbsDown } from 'lucide-react';
...
},
{
  ...
  description: "Funding opportunity to support early-career African researchers in scientific fields.",
  type: "research",
  tags: ["Funding", "Science", "Africa"],
  image: "https://images.unsplash.com/photo-1573496529575-870a6e5cf0c6?auto=format&fit=crop&q=80&w=800",
...
},
{
  ...
  description: "Funding opportunity for research partnerships in various disciplines.",
  type: "research",
  tags: ["Funding", "Grants", "Research"],
  image: "https://images.unsplash.com/photo-1564865878902-97dfcbe39652?auto=format&fit=crop&q=80&w=800",
...
},
{
  ...
  image: "https://images.unsplash.com/photo-1600255822015-1f3df0e9f84f?auto=format&fit=crop&q=80&w=800",
...
},
{
  ...
  image: "https://images.unsplash.com/photo-1506811873867-9c3ddf7b6945?auto=format&fit=crop&q=80&w=800",
...
},
{
  ...
  description: "European research funding for global health and infectious diseases.",
  type: "research",
  tags: ["Funding", "Healthcare", "EDCTP3"],
  image: "https://images.unsplash.com/photo-1603209051785-cdabee45d8d3?auto=format&fit=crop&q=80&w=800",
...
},
{
  ...
  image: "https://images.unsplash.com/photo-1581092331583-2a31b4b28a7e?auto=format&fit=crop&q=80&w=800",
...
},
{
  ...
  image: "https://images.unsplash.com/photo-1603791452906-75a539ff1907?auto=format&fit=crop&q=80&w=800",
...
},
{
  ...
  image: "https://images.unsplash.com/photo-1612531392393-6509fe5f8987?auto=format&fit=crop&q=80&w=800",
...
},
{
  ...
  image: "https://images.unsplash.com/photo-1580894732930-a41e9da3d69e?auto=format&fit=crop&q=80&w=800",
...
},
{
    ...
    description: 'WFD seeks experts for a research project on democratic governance in Kenya.',
...
},
{
    ...
    description: 'Funding opportunities for projects focused on health, policy, and education.',
...
function ReportsSection() {
  ...
  const [filteredItems, setFilteredItems] = useState<FeaturedItem[]>(featuredItems);
  ...
  const filterItems = useCallback(() => {
    ...
    return featuredItems.filter((item) => {
      ...
      const matchesCategory =
        ...
        selectedCategories.some(cat => item.type === cat || item.tags.includes(cat));
      ...
      if (dateRange !== "all" && item.publishedDate) {
        ...
        const now = new Date();
        const monthsAgo = new Date(now.setMonth(now.getMonth() - parseInt(dateRange)));
        matchesDate = itemDate >= monthsAgo;
      }

      return matchesSearch && matchesCategory && matchesImpactFactor && matchesDate;
      ...
      <div className="relative overflow-hidden bg-white/30 backdrop-blur-sm border-b border-slate-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 relative">
          <div className="text-center max-w-3xl mx-auto">
            <h1 className="text-5xl md:text-6xl font-bold mb-6 bg-clip-text text-transparent bg-[#34D399]">
              Research Resources Hub
            </h1>
            <p className="text-lg md:text-xl text-slate-600 mb-12 leading-relaxed">
              Discover AI-powered recommendations and trending research resources
            </p>
            ...
            {showAdvancedFilters && (
              <div className="mt-4 p-6 bg-white rounded-xl shadow-lg">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div>
                    <label className="block text-sm font-medium text-slate-700 mb-2">Minimum Impact Factor</label>
                    <input
                      type="number"
                      min="0"
                      step="0.1"
                ...
                return (
                  <button
                    ...
                    className={`flex items-center gap-2 px-6 py-3 rounded-full text-sm font-medium transition-all duration-300 ease-out transform hover:scale-105 ${
                      isSelected
                        ? "bg-[#34D399] text-black shadow-lg shadow-blue-500/25"
          ...
          {filteredItems.slice(0, visibleCount).map((item, index) => (
            ...
            >
              <div className="h-48 w-full overflow-hidden">
                ...
                />
                {item.impactFactor && (
                  <div className="absolute top-4 right-4 bg-[#34D399] text-white px-3 py-1 rounded-full text-sm font-medium">
        ...
        <div className="text-center mt-8 space-y-4">
          {visibleCount < filteredItems.length && (
            <button
              ...
              className="px-6 py-3 rounded-full bg-[#34D399] text-white text-lg font-medium transition-all duration-300 ease-out transform hover:scale-105 flex items-center gap-2 mx-auto"
            >
