...
const Stats = () => {
  ...
  return (
    <div className="w-[70%] mx-auto"> {/* Container div with 70% width */}
      <div className={`grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 lg:gap-6 transition-opacity duration-700 ${isVisible ? 'opacity-100' : 'opacity-0'}`}>
        {/* Yearly Growth Card */}
        <div className="bg-[#047857] p-6 lg:p-8 rounded-lg relative overflow-hidden transform transition-all duration-300 hover:scale-[1.02] hover:shadow-lg group">
          <div className="relative z-10">
            <div className="text-white">
              <h2 className="text-lg lg:text-xl font-bold mb-2 transform transition-transform group-hover:translate-x-1">YEARLY GROWTH IN</h2>
              <h3 className="text-lg lg:text-xl mb-2 transform transition-transform delay-75 group-hover:translate-x-1">AFRICAN RESEARCH</h3>
              <h3 className="text-lg lg:text-xl mb-4 transform transition-transform delay-100 group-hover:translate-x-1">PUBLICATIONS</h3>
            </div>
            <div className="flex items-end gap-2 mt-4 transform transition-all duration-300 group-hover:scale-105">
              ...
              <div className="text-[36px] lg:text-[50px] font-bold text-white leading-none mb-2">%</div>
            </div>
        ...
        <div className="bg-white rounded-lg p-6 lg:p-8 border-2 border-green-400 transform transition-all duration-300 hover:scale-[1.02] hover:shadow-lg group">
          <div className="text-[#4ADE80] mb-4">
            <h2 className="text-lg lg:text-xl font-bold transform transition-transform group-hover:translate-x-1">PUBLICATION GROWTH</h2>
            <div className="text-yellow-400 font-bold mt-2 transform transition-transform delay-75 group-hover:translate-x-1">
          ...
          <div className="relative h-[180px] lg:h-[220px] mt-6 transition-transform duration-500 group-hover:scale-[1.02]">
            <svg className="w-full h-full" viewBox="0 0 460 250" preserveAspectRatio="none">
              {/* Background Grid */}
              {[0, 1, 2, 3, 4].map((i) => (
                <line
                  key={`grid-${i}`}
              ...
              {[
                ...
                <g key={`point-${i}`} className="transform transition-transform duration-300 group-hover:scale-110">
                  <circle
                    cx={point.x}
                    cy={point.y}
                    r="6"
                  ...
                  <text
                    ...
                    y={point.y - 15}
                    textAnchor="middle"
                    className="text-xs font-bold fill-yellow-400 transition-all duration-300 group-hover:font-extrabold"
                  >
                    {point.value}
                  </text>
                </g>
        ...
        <div className="grid gap-4">
          ...
          <div className="bg-white p-6 rounded-lg border-2 border-green-400 transform transition-all duration-300 hover:scale-[1.02] hover:shadow-lg group">
            <h3 className="text-[#4ADE80] text-lg font-bold mb-6 transform transition-transform group-hover:translate-x-1">
              RESEARCH METRICS
            </h3>
            <div className="space-y-6">
              ...
              <div className="transform transition-all duration-300 hover:translate-x-1">
                <div className="flex justify-between text-sm mb-2">
                  <span className="text-[#4ADE80] font-semibold">High Impact Publications</span>
                  <span className="text-yellow-400 font-bold">73%</span>
                </div>
                <div className="h-3 bg-gray-100 rounded-full overflow-hidden">
                  <div
                    className="h-full bg-[#047857] rounded-full transition-all duration-1000 ease-out"
              ...
              <div className="transform transition-all duration-300 hover:translate-x-1">
                <div className="flex justify-between text-sm mb-2">
                  <span className="text-[#4ADE80] font-semibold">Peer-Reviewed Articles</span>
          ...
          {/* Impact Metrics */}
          <div className="bg-[#047857] p-6 rounded-lg transform transition-all duration-300 hover:scale-[1.02] hover:shadow-lg group">
            <div className="space-y-6">
              <div className="transform transition-all duration-300 hover:translate-x-1">
              ...
              <div className="transform transition-all duration-300 hover:translate-x-1">
                ...
                <div className="text-sm text-white">INTERNATIONAL COLLABORATION</div>
                <div className="h-2 bg-white/30 mt-2 rounded-full overflow-hidden">
                  <div
                    className="h-full bg-white rounded-full transition-all duration-1000 ease-out"
                    style={{ width: isVisible ? '73%' : '0%' }}
        ...
        <div className="bg-[#047857] p-6 lg:p-8 col-span-1 md:col-span-2 lg:col-span-2 rounded-lg transform transition-all duration-300 hover:scale-[1.02] hover:shadow-lg group">
          <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-6">
            <div>
              <h2 className="text-white text-lg mb-2 transform transition-transform group-hover:translate-x-1">TOTAL PUBLISHED</h2>
              <div className="text-white text-4xl lg:text-5xl font-bold flex items-baseline gap-2 transform transition-all duration-300 group-hover:scale-105">
                2.3K
                <span className="text-sm font-normal opacity-90">RESEARCH PAPERS</span>
              </div>
