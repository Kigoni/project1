...
export default function SubmitJournalDialog({
  open,
  onOpenChange,
}: {
  open: boolean;
        ...
        <DialogFooter className="flex flex-col sm:flex-row sm:justify-between sm:space-x-2">
          ...
          <div className="flex items-center text-xs text-muted-foreground mt-4 sm:mt-0">
            <svg className="h-3 w-3 mr-1" viewBox="0 0 24 24">
              <path
                d="M14 2H6c-1.1 0-1.99.9-1.99 2L4 20c0 1.1.89 2 1.99 2H18c1.1 0 2-.9 2-2V8l-6-6zm4 18H6V4h12v16zm-6-7h2v-2h-2v2zm0-4h2v-2h-2v2zM8 7h8v2H8V7z"
                fill="currentColor"
              />
            </svg>
