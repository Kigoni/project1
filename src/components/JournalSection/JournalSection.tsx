      ...
      <section className="py-16">
        <div className="max-w-6xl mx-auto px-4">
          <div className="text-center mb-10">
            <h2 className="text-5xl font-bold mb-6 text-[#4ADE80]">
              Featured Journals
            </h2>
            ...
            {[
              ...
              >
                ...
                <div className="relative p-6 h-72 flex flex-col justify-end">
                  <div className={`p-2 rounded-lg bg-gradient-to-r ${item.color} w-fit mb-3`}>
                    <item.icon className="h-5 w-5 text-white" />
                  </div>
                  <h3 className="text-xl font-bold mb-2 text-white">{item.title}</h3>
                  <p className="text-gray-200 text-sm mb-4">{item.description}</p>
                  <button className={`flex items-center gap-2 text-white bg-gradient-to-r ${item.color} px-4 py-2 rounded-full w-fit group-hover:gap-3 transition-all text-sm`}>
            ...
            {[
              ...
              >
                ...
                <div className="relative p-8 h-[400px] flex flex-col justify-end">
                  <div className={`p-3 rounded-lg bg-gradient-to-r ${item.color} w-fit mb-4`}>
                    <item.icon className="h-6 w-6 text-white" />
                  </div>
                  <h3 className="text-2xl font-bold mb-3 text-white">{item.title}</h3>
                  <p className="text-gray-200 text-base mb-6">{item.description}</p>
                  <button className={`flex items-center gap-2 text-white bg-gradient-to-r ${item.color} px-6 py-3 rounded-full w-fit group-hover:gap-3 transition-all`}>
